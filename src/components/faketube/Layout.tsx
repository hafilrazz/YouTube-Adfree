...
import { Menu, Search, Mic, Video, Bell, Home, Music2, Gamepad2, Newspaper, Trophy, Lightbulb, Clapperboard, History, ThumbsUp, Clock, ListVideo, Loader2, CheckCircle2, Film, Radio, X } from "lucide-react";
